          ...
          <div className="rounded-[2rem] bg-white/90 px-8 py-8 shadow-panel backdrop-blur">
            ...
            <div className="mt-8 space-y-6">
              <div className="rounded-2xl border border-stone-200 bg-mist/65 p-6">
                <div className="mb-2 h-6 w-32 animate-pulse rounded bg-stone-200" />
                <div className="mb-5 h-3 w-64 animate-pulse rounded bg-stone-200" />
              ...
              <div className="rounded-2xl border border-stone-200 bg-mist/65 p-6">
                <div className="mb-2 h-6 w-40 animate-pulse rounded bg-stone-200" />
                <div className="mb-5 h-3 w-48 animate-pulse rounded bg-stone-200" />
                <SkeletonCards />
              </div>
            </div>
          </div>
